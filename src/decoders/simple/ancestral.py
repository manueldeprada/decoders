...
from ..strategies.utils import GenerationStrategy, SampleEncoderDecoderOutput, SampleDecoderOnlyOutput
...
"""
        ...
        output_attentions = (
            output_attentions if output_attentions is not None else model.config.output_attentions
        )
