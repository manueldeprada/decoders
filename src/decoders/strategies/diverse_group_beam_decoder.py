...
class DiverseGroupBeamDecoder(GenerationStrategy):
    """
    Implements group beam decoding method.
    """
    ...
    def __call__(self,
        ...
        if self.check_config:
            ...
            if self.config.num_beams % self.config.num_beam_groups != 0:
            ...
            has_default_typical_p = typical_p is None and self.config.typical_p == 1.0
        ...
        # 13. run group beam search decoding
        # init values
        ...
        num_beam_groups = self.scorer.num_beam_groups
        num_sub_beams = num_beams // num_beam_groups
        batch_size = len(self.scorer._beam_hyps) // num_beam_groups
        device = input_ids.device
